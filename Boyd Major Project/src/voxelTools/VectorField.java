...
public class VectorField {
	  ...
	  VectorField(int _w, int _h, int _d, int _s, FlockingApp _parent) {
		  parent = _parent;
		  w = _w;
		  h = _h;
		  d = _d;
	  ...
	  public void interpolateFieldFromRandomVectors(int numInitialVectors) {
	  ...
	  public  Vec3D getFieldAtPoint(Vec3D pt, HashMap<Vec3D, Vec3D>field, float cutoff){
		  Vec3D val = new Vec3D();
	  ...
	  public Vec3D getValue(int x, int y, int z) {
	  ...
	  public void render(int res, float length) {
		  int index = 0;
