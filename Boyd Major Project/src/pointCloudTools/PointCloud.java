...
public class PointCloud {
	...
	public PointCloud(PApplet _parent){
		...
		colours = new float[0];
		parent = _parent;
		tree = new Plane3DOctree(new Vec3D(0,0,-500), 2000);
		loaded = false;
	}
	...
	public void buildTree(){
		tree = new Plane3DOctree(new Vec3D(-500,-500,-500), 2000);
	...
	public void extractRGBThreshold(float r, float g, float b, boolean aboveThreshold){
		if(aboveThreshold){
			extractRGBMinMax(r, g, b, 255,255,255);
		}else extractRGBMinMax(0,0,0,r, g, b);
	}
	
	public void extractRGBRange(float r, float g, float b, float range){
		extractRGBMinMax(r-range, g-range, b-range, r+range,g+range,b+range);
	}
	
	public void extractRGBMinMax(float rMin, float gMin, float bMin, float rMax, float gMax, float bMax){
		int count = 0;
